        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/bs-icons.png') }}" alt="main logo">
                </div>
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ Vite::asset('resources/images/bs-theme.png') }}" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
